...
def get_flowers_dataframes(train_percentage = 0.8, test_percentage = 0.1):
    """
...
def get_image_generators_from_dataframes(train_data, test_data, val_data):
    """
    ...
    train_generator = train_datagen.flow_from_dataframe(train_data, BASE_DIR, target_size=(500, 500), batch_size=20, class_mode='categorical')
    test_generator = test_datagen.flow_from_dataframe(test_data, BASE_DIR, target_size=(500, 500), batch_size=20, class_mode='categorical')
